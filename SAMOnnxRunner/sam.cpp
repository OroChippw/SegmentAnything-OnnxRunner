...
struct SamModel {
    ...
    SamModel(const std::string& preModelPath, const std::string& samModelPath, int threadsNumber) {
        ...
        //const wchar_t* encoder_modelpath = multi_Byte_To_Wide_Char(preModelPath);
        //const wchar_t* decoder_modelpath = multi_Byte_To_Wide_Char(samModelPath);
#else
    ...
    bool loadImage(const cv::Mat& image) {
        ...
        std::cout << outputTensorValuesPre.size() << std::endl;
